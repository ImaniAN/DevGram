...
-- Last modification date: 2021-03-25 13:37:51.379
...
CREATE TABLE user_account (
    ...
    user_account_status_id int  NOT NULL,
...
CREATE TABLE user_account_status (
    ...
    code varchar(20)  NOT NULL,
    name varchar(100)  NOT NULL,
    CONSTRAINT user_account_status_ak_1 UNIQUE (code) NOT DEFERRABLE  INITIALLY IMMEDIATE,
    CONSTRAINT user_account_status_pk PRIMARY KEY (id)
);
...
-- Reference: user_account_user_account_status (table: user_account)
ALTER TABLE user_account ADD CONSTRAINT user_account_user_account_status
